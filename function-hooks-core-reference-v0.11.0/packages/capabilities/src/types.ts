...
export type CapabilityImplementation =
  | McpCapabilityImplementation
  | HttpCapabilityImplementation
  | BrowserCapabilityImplementation
  | DesktopCapabilityImplementation
  | ProcessCapabilityImplementation
  | FileReadCapabilityImplementation
  | FileWriteCapabilityImplementation;
...
export interface CreateCapabilityCandidateInput {
  ...
  readonly sensitivity: CapabilitySensitivity;
  readonly risk: CapabilityRisk;
  readonly provenance: Omit<CapabilityProvenance, "schemaDigest" | "discoveredAt"> & { readonly discoveredAt?: string };
  readonly implementation: CapabilityImplementation;
}
