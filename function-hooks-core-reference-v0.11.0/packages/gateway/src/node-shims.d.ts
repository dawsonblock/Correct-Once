...
declare module "node:fs/promises" {
  ...
  export function open(path: string, flags: string | number, mode?: number): Promise<any>;
...
declare module "node:http" {
  export function request(url: string | URL, options: any, callback: (response: any) => void): any;
}
...
declare module "node:net" {
  ...
  export class BlockList {
    addSubnet(network: string, prefix: number, family?: string): void;
    check(address: string, family?: string): boolean;
  }
}
