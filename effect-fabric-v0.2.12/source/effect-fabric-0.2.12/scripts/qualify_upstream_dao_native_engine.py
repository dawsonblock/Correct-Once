#!/usr/bin/env python3
"""Run official DAO conformance through the v0.2.12 Effect Fabric native transition kernel."""
...
def make_native_worker(source: str) -> str:
    ...
    header = (
        "// Derived scheduling shell for Effect Fabric v0.2.12 (donor worker.ts is MIT).\n"
