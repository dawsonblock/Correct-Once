// Effect Fabric native durable-effect transition kernel, v0.2.12.
//
// Derived from durable-agent-outbox packages/core/src/reduce.ts (MIT) and maintained as an
// Effect Fabric compatibility kernel. The direct v0.2.12 qualification path imports THIS source,
...
export const EFFECT_FABRIC_NATIVE_KERNEL_VERSION = "0.2.12";
